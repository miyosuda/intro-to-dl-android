...
# 変数Wとbを初期化する. 初期化すると、tf.zeros()が実行され、
# Wとbはすべて0になる.
tf.initialize_all_variables().run()

# 学習開始. 上記のずれを小さくする学習を1000回繰り返す.
for i in range(1000):
  # 画像データと、正解データをそれぞれ学習用データセット55000個の中からランダムで100個ずつ集めてくる.
...
# 学習が終わったので、結果を確認してみる
# ニューラルネットが出力した10個の値の中でどれが最大だったindexと
# 正解データの10個の値の中でどれが最大だったかのindexを比較し
